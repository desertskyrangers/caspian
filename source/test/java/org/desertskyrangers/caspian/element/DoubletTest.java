...
//	}
	...
	private static Stream<Arguments> velocityValues() {
		return Stream.of(
			// Y = 2
			Arguments.of( 0, 0, 0, 1, -2, 2, 0, 1 / (Cfd.TWO_PI * 4 * Cfd.SQRT_2 * Cfd.SQRT_2) ),
			Arguments.of( 0, 0, 0, 1, -1, 2, 0.01909859317102744, 0.025464790894703253 ),
			Arguments.of( 0, 0, 0, 1, 0, 2, 1 / (Cfd.TWO_PI * 2 * 2), 0 ),
			Arguments.of( 0, 0, 0, 1, 1, 2, 0.01909859317102744, -0.025464790894703253 ),
			Arguments.of( 0, 0, 0, 1, 2, 2, 0, -1 / (Cfd.TWO_PI * 4 * Cfd.SQRT_2 * Cfd.SQRT_2) ),
			// Y = 1
			//Arguments.of( 0, 0, 0, 1, -2, 1, 0, 1 / (Cfd.TWO_PI * 4 * Cfd.SQRT_2 * Cfd.SQRT_2) ),
			Arguments.of( 0, 0, 0, 1, -1, 1, 0, 1 / (Cfd.TWO_PI * Cfd.SQRT_2 * Cfd.SQRT_2) ),
			Arguments.of( 0, 0, 0, 1, 0, 1, 1 / (Cfd.TWO_PI * 1 * 1), 0 ),
			Arguments.of( 0, 0, 0, 1, 1, 1, 0, -1 / (Cfd.TWO_PI * Cfd.SQRT_2 * Cfd.SQRT_2) ),
			//Arguments.of( 0, 0, 0, 1, 2, 1, 0, -1 / (Cfd.TWO_PI * 4 * Cfd.SQRT_2 * Cfd.SQRT_2) ),
			// Y = 0
			Arguments.of( 0, 0, 0, 1, -2, 0, -1 / (Cfd.TWO_PI * 2 * 2), 0 ),
			Arguments.of( 0, 0, 0, 1, -1, 0, -1 / (Cfd.TWO_PI * 1 * 1), 0 ),
			Arguments.of( 0, 0, 0, 1, 0, 0, Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY ),
			Arguments.of( 0, 0, 0, 1, 1, 0, -1 / (Cfd.TWO_PI * 1 * 1), 0 ),
			Arguments.of( 0, 0, 0, 1, 2, 0, -1 / (Cfd.TWO_PI * 2 * 2), 0 ),
			// Y = -1
			//Arguments.of( 0, 0, 0, 1, -2, -1,  ),
			Arguments.of( 0, 0, 0, 1, -1, -1, 0, -1 / (Cfd.TWO_PI * Cfd.SQRT_2 * Cfd.SQRT_2) ),
			Arguments.of( 0, 0, 0, 1, 0, -1, 1 / (Cfd.TWO_PI * 1 * 1), 0 ),
			Arguments.of( 0, 0, 0, 1, 1, -1, 0, 1 / (Cfd.TWO_PI * Cfd.SQRT_2 * Cfd.SQRT_2) ),
			//Arguments.of( 0, 0, 0, 1, 2, -1,  ),
