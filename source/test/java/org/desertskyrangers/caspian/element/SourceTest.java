...
public class SourceTest {
	...
	@Test
	void testVelocity() {
//		assertThat( new Source( 0, 0, 1 ).velocity( 1, 0 ) ).isEqualTo( new double[]{ 1, 0 } );
//		assertThat( new Source( 0, 0, 1 ).velocity( 0, 1 ) ).isEqualTo( new double[]{ 0, 1} );
//		assertThat( new Source( 0, 0, 1 ).velocity( -1, 0 ) ).isEqualTo( new double[]{ -1, 0 } );
//		assertThat( new Source( 0, 0, 1 ).velocity( 0, -1 ) ).isEqualTo( new double[]{ 0,-1 } );
//
//		assertThat( new Source( 0, 0, 1 ).velocity( 2, 0 ) ).isEqualTo( new double[]{ 0.5, 0 } );
//		assertThat( new Source( 0, 0, 1 ).velocity( 0, 2 ) ).isEqualTo( new double[]{ 0, 0.5} );
//		assertThat( new Source( 0, 0, 1 ).velocity( -2, 0 ) ).isEqualTo( new double[]{ -0.5, 0 } );
//		assertThat( new Source( 0, 0, 1 ).velocity( 0, -2 ) ).isEqualTo( new double[]{ 0,-0.5 } );
